      ...
      <main className="pt-28 pb-20 px-6 relative overflow-hidden" 
        ...
        <header className="text-center mb-12 relative z-10">
          <div className="inline-block px-3 py-1 mb-4 rounded-full border border-primary-container/20 bg-primary-container/5">
            <span className="text-[10px] font-bold uppercase tracking-[0.2em] text-primary-container">Premium Access</span>
          </div>
        ...
        {/* Pricing Tiers */}
        <div className="flex flex-col gap-6 max-w-md mx-auto relative z-10">
          
          {/* Free Tier */}
          <div className="p-6 rounded-xl bg-surface-container border border-outline/10 hover:border-outline/30 transition-all duration-300">
            <div className="flex justify-between items-start mb-6">
              <div>
                <h3 className="text-xs font-bold uppercase tracking-widest text-on-surface-variant mb-1">Standard</h3>
            ...
            <button className="w-full py-3 px-6 rounded-full border border-outline text-on-surface font-bold text-sm tracking-wide active:scale-[0.98] transition-transform">
              Seleziona Base
            </button>
          </div>

          {/* Pro Tier (Highlighted) */}
          <div className="p-6 rounded-xl bg-surface-container-high border-2 border-primary-container shadow-[0_0_40px_rgba(13,242,89,0.08)] relative overflow-hidden">
            ...
            <div className="flex justify-between items-start mb-6">
              <div>
                <h3 className="text-xs font-bold uppercase tracking-widest text-primary-container mb-1">Pro Tier</h3>
            ...
            <ul className="space-y-4 mb-8">
              ...
              <li className="flex items-center gap-3 text-sm text-on-surface">
                <span className="material-symbols-outlined text-primary-container text-sm">show_chart</span>
                Advanced charting
              </li>
              <li className="flex items-center gap-3 text-sm text-on-surface">
                <span className="material-symbols-outlined text-primary-container text-sm">support_agent</span>
                Priority support
              </li>
            </ul>
            <button className="w-full py-4 px-6 rounded-full bg-primary-container text-[#00390e] font-extrabold text-sm tracking-wide shadow-[0_4px_20px_rgba(13,242,89,0.3)] active:scale-[0.98] transition-transform">
              Inizia Ora
            </button>
          </div>

          {/* Institutional Tier */}
          <div className="p-6 rounded-xl bg-surface-container border border-outline/10">
            <div className="flex justify-between items-start mb-6">
              <div>
                <h3 className="text-xs font-bold uppercase tracking-widest text-on-surface-variant mb-1">Elite</h3>
                <p className="text-2xl font-extrabold">Institutional</p>
              </div>
              <div className="text-right">
                <span className="text-3xl font-extrabold tracking-tight">$199</span>
                <span className="text-xs font-medium text-on-surface-variant">/mo</span>
              </div>
            </div>
            <ul className="space-y-4 mb-8">
              ...
              <li className="flex items-center gap-3 text-sm text-on-surface-variant">
                <span className="material-symbols-outlined text-sm">person_celebrate</span>
            ...
            <button className="w-full py-3 px-6 rounded-full border border-outline/20 text-on-surface bg-surface-variant/20 backdrop-blur-xl font-bold text-sm tracking-wide active:scale-[0.98] transition-transform">
              Contatta Sales
            </button>
          </div>
        </div>
